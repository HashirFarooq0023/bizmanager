                ...
                <div>
                    ...
                    <div className="bg-white dark:bg-[rgb(var(--color-card))] rounded-lg shadow-sm border dark:border-[rgb(var(--color-border))] p-3 space-y-1.5">
                        <div className="flex justify-between text-xs">
                            ...
                            <span className="text-xs font-semibold text-gray-900 dark:text-[rgb(var(--color-text))]">Rs. {calculatedTotals.subtotal.toFixed(2)}</span>
                        </div>
                        <div className="flex justify-between text-xs">
                            <span className="text-gray-600 dark:text-[rgb(var(--color-text-secondary))]">Item Discount:</span>
                            <span className="text-xs text-red-600 dark:text-red-400">- Rs. {calculatedTotals.itemDiscount.toFixed(2)}</span>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="bg-white dark:bg-[rgb(var(--color-card))] rounded-lg shadow-sm border dark:border-[rgb(var(--color-border))] p-3 space-y-1.5">
                        <div className="flex justify-between text-xs">
                            ...
                            <span className="text-xs font-semibold text-gray-900 dark:text-[rgb(var(--color-text))]">Rs. {calculatedTotals.totalCGST.toFixed(2)}</span>
                        </div>
                        <div className="flex justify-between text-xs">
                            <span className="text-gray-600 dark:text-[rgb(var(--color-text-secondary))]">SGST:</span>
                            <span className="text-xs font-semibold text-gray-900 dark:text-[rgb(var(--color-text))]">Rs. {calculatedTotals.totalSGST.toFixed(2)}</span>
                        </div>
                        <div className="flex justify-between text-xs">
                            <span className="text-gray-600 dark:text-[rgb(var(--color-text-secondary))]">IGST:</span>
                            <span className="text-xs font-semibold text-gray-900 dark:text-[rgb(var(--color-text))]">Rs. {calculatedTotals.totalIGST.toFixed(2)}</span>
                        </div>
                        <div className="flex justify-between border-t border-gray-300 dark:border-[rgb(var(--color-border))] pt-1.5 mt-1.5 text-xs">
                            ...
                            <span className="text-xs font-semibold text-gray-900 dark:text-[rgb(var(--color-text))]">Rs. {calculatedTotals.taxAmount.toFixed(2)}</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="bg-white dark:bg-[rgb(var(--color-card))] rounded-lg shadow-sm border-2 border-indigo-200 dark:border-[rgb(var(--color-border))] p-3">
                    <div className="flex justify-between items-center">
                        ...
                        <span className="text-lg font-bold text-blue-600 dark:text-blue-400">
                            Rs. {calculatedTotals.totalAmount.toFixed(2)}
                        </span>
                    </div>
                ...
                <div className="bg-white dark:bg-[rgb(var(--color-card))] rounded-lg shadow-sm border dark:border-[rgb(var(--color-border))] p-3">
                    ...
                    <div className="space-y-1.5 text-xs">
                        <div className="flex justify-between">
                            ...
                            <span>Rs. {calculatedTotals.subtotal.toFixed(2)}</span>
                        </div>
                        <div className="flex justify-between">
                            <span className="text-gray-600">Item Discount:</span>
                            <span className="text-red-600">- Rs. {calculatedTotals.itemDiscount.toFixed(2)}</span>
                        </div>
                        <div className="flex justify-between">
                            <span className="text-gray-600">Bill Discount:</span>
                            <span className="text-red-600">- Rs. {calculatedTotals.billDiscount.toFixed(2)}</span>
                        </div>
                        <div className="flex justify-between">
                            <span className="text-gray-600">Tax Amount:</span>
                            <span>+ Rs. {calculatedTotals.taxAmount.toFixed(2)}</span>
                        </div>
                        <div className="flex justify-between">
                            <span className="text-gray-600">Transport Charges:</span>
                            <span>+ Rs. {formData.transportCharges}</span>
                        </div>
                        <div className="flex justify-between">
                            <span className="text-gray-600">Handling Charges:</span>
                            <span>+ Rs. {formData.handlingCharges}</span>
                        </div>
                        <div className="flex justify-between">
                            <span className="text-gray-600">Restocking Fee:</span>
                            <span>+ Rs. {formData.restockingFee}</span>
                        </div>
                        <div className="flex justify-between">
                            <span className="text-gray-600">TDS:</span>
                            <span className="text-red-600">- Rs. {formData.tdsAmount}</span>
                        </div>
                        <div className="flex justify-between border-t border-gray-300 dark:border-[rgb(var(--color-border))] pt-1.5 mt-1.5 font-semibold text-xs">
                            <span>Total:</span>
                            <span>Rs. {calculatedTotals.totalAmount.toFixed(2)}</span>
                        </div>
                    </div>
                </div>
            </div>
