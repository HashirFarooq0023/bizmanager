        ...
        <Layout>
            <div className="space-y-6">
                <PageHeader
                    ...
                    subtitle="Track and manage supplier purchase bills, payments, and liabilities"
                    action={
                ...
                <Card noPadding>
                    ...
                    <DataTable
                        ...
                        emptyMessage={searchTerm ? "No bills match your search criteria" : "No purchase bills recorded"}
                        isLoading={isLoading}
                    />
                        ...
                        <div className="p-4 border-t border-gray-100 dark:border-gray-800 flex items-center justify-between">
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                <span className="text-xs font-medium text-gray-700 dark:text-gray-300">
                                    Page {currentPage} of {Math.ceil(filteredBills.length / itemsPerPage) || 1}
                                </span>
                                <Button
                                    variant="secondary"
                                    size="sm"
